  ...
  render() {
     return (
       <div style={{backgroundColor:'#2e2f30',height: '100vh',overflow:'hidden'}}>
         ...
         <Grid>
           <CardComponent image='http://www.pngall.com/wp-content/uploads/2016/05/Avocado-PNG-Clipart.png' name='Avacado' percent='25%' np='€8' cp='€10' door='€5' margin='0%' newprice='75%'/>
           ...
           <ButtonComponent button1='View Products' button2='Approve' />
       </Grid>
      </div>
    );
  }
